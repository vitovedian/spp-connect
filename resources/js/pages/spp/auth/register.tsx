                ...
                <div className="grid flex-1 items-center gap-12 px-6 py-12 lg:grid-cols-[1fr_1fr] lg:px-12">
                    <aside className="mx-auto max-w-xl text-center lg:text-left">
                        ...
                        <h1 className="mt-4 text-4xl font-semibold leading-tight text-white md:text-5xl">
                            Launch your next stakeholder initiative today
                        </h1>
                        <p className="mt-5 text-base text-slate-300">
                            Build meaningful connections, track impact, and collaborate with your team in
                            real time. Create your account to unlock the SPP workspace.
                        </p>
                    </aside>
                            ...
                            {({ processing, errors }) => (
                                <>
                                    <header className="space-y-2 text-center">
                                        <h2 className="text-2xl font-semibold text-white">Create your SPP account</h2>
                                    ...
                                    <div className="space-y-5 text-left">
                                        ...
                                        {mustVerifyEmail && (
                                            <p className="rounded-md border border-amber-400/40 bg-amber-500/10 px-4 py-2 text-xs text-amber-100">
                                                After registering, we will send a verification link to your email.
                                            </p>
                                        )}
                                    </div>
